...
namespace Pr3Obligatorio_AAN2023.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Telefono,Email,Constraseña")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Telefono,Email,Constraseña")] Usuario usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
